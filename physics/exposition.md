...
3 Background radiation is a naturally-occuring radiation and must be subtracted from measurements of radiation
\ Origins:
\
...
2 In a nuclear reactor, the moderator is required to slow fast-moving fission neutrons into thermal neutrons that can induce further fission events
