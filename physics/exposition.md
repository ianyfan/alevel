...
4.2.2
2 The denser the field lines in an area, the stronger the force
...
4.3.2
1 \\(E\\) is the gravitational field strength
2 The denser the field lines in an area, the stronger the force
3 \\[\begin{align}
\   E & = \frac{F}{q}
...
4.3.3
1 The electric potential at a point is the work done per kilogram to move a positive charge from infinity to that point
3 \\[\begin{align}
\   V & = \frac{1}{q}W
...
4.4.1
1 Capacitance is measured in terms of charge per voltage, with unit coulombs per volt
...
\ \\\ \frac{1}{Q}\frac{\mathrm{d}Q}{\mathrm{d}t} & = -k
\ \\\ \int Q^{-1} \mathrm{d}Q & = \int -k \mathrm{d}t
\ \\\ \ln Q & = -kt + \ln A
\ \\\ Q & = Ae^{-kt}
\ \end{align}\\]
...
4 The tesla is the measure of magnetic flux density, in newtons per ampere metres
...
\ \\\ \int N^{-1} \mathrm{d}N & = \int -\lambda \mathrm{d}t
...
5.2.1
1 Binding energy is the energy required to disassemble a nucleus into its nucleons and is calculated from the total energy of the unbound nucleons minus the energy of the nucleus
\ This also applies to atoms when electrons are included
3 Atomic mass unit is one twelfth of the mass of an unbound carbon-12 atom, equal to \\(\SI{1}{\gram\per\mole}\\), and is approximately the mass of one nucleon
...
2 The specific heat capacity of a substance is the amount of thermal energy required to raise the temperature of one kilogram by one Kelvin
3 The specific latent of a substance is the amount of thermal energy required to change the state of a kilogram
...
5 The molar mass of a substance is its mass divided by the number of moles in it
\ The molecular mass of a molecule is the total mass of its atoms \(\)
